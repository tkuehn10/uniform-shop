...
export type StockMovementReason = 'delivery' | 'sale' | 'stocktake_adjustment' | 'manual_adjustment'
...
export interface Database {
  public: {
    Tables: {
      ...
      delivery_lines: { Row: DeliveryLine; Insert: Partial<DeliveryLine>; Update: Partial<DeliveryLine> }
      stocktakes: { Row: Stocktake; Insert: Partial<Stocktake>; Update: Partial<Stocktake> }
      stocktake_counts: { Row: StocktakeCount; Insert: Partial<StocktakeCount>; Update: Partial<StocktakeCount> }
      ...
      opening_time_slots: { Row: OpeningTimeSlot; Insert: Partial<OpeningTimeSlot>; Update: Partial<OpeningTimeSlot> }
      roster_claims: { Row: RosterClaim; Insert: Partial<RosterClaim>; Update: Partial<RosterClaim> }
      school_holidays: { Row: SchoolHoliday; Insert: Partial<SchoolHoliday>; Update: Partial<SchoolHoliday> }
    }
  }
}
